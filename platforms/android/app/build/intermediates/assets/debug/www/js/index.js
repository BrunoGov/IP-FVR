...
function btn_login() {
  $('#form_login').removeClass('animated fadeOutDown');
  $('#form_login').css({'display':'block'});
  $('#content_login').addClass('animated fadeOut');
  setTimeout(function(){
    $('#content_login').css({'display':'none'});
  } ,1000);
  $('#form_login').addClass('animated fadeInUp delay-1s');
}

function btn_cad_aluno() {
  $('#cad_aluno').removeClass('animated fadeOutDown');
  $('#cad_aluno').css({'display':'block'});
  $('#content_login').addClass('animated fadeOut');
  setTimeout(function(){
    $('#content_login').css({'display':'none'});
  } ,1000);
  $('#cad_aluno').addClass('animated fadeInUp delay-1s');
}

function btn_back_cad() {
  $('#cad_aluno').removeClass('animated fadeInUp delay-1s');
  $('#content_login').removeClass('animated fadeOut');
  $('#cad_aluno').addClass('animated fadeOutDown');
  setTimeout(function(){
    $('#cad_aluno').css({'display':'none'});
    $('#content_login').css({'display':'block'});
  } ,1000);
  $('#content_login').addClass('animated fadeInUp');
}

function btn_back_formLogin() {
  $('#form_login').removeClass('animated fadeInUp delay-1s');
  $('#content_login').removeClass('animated fadeOut');
  $('#form_login').addClass('animated fadeOutDown');
  setTimeout(function(){
